    ...
    <view class="relative z-10">
      ...
      >
        <view class="flex items-center gap-[12rpx]">
          ...
          <text class="text-[32rpx] font-700 tracking-[1px]" :style="{ color: '#2ED573' }">我的</text>
        </view>
      </view>
      ...
      <view class="relative px-[24rpx] mt-[20rpx]">
        <view class="w-full rounded-[24rpx] overflow-hidden relative border border-white/10">
          <view class="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" />
          ...
          <view class="absolute left-0 top-0 w-full h-full overflow-hidden">
            <view class="absolute left-[20rpx] top-[20rpx] w-[200rpx] h-[200rpx] rounded-full bg-primary/5 blur-[80rpx]" />
            <view class="absolute right-[30rpx] bottom-[10rpx] w-[150rpx] h-[150rpx] rounded-full bg-primary/10 blur-[60rpx]" />
          </view>
          <view class="relative px-[32rpx] py-[36rpx]">
            <view class="flex items-center gap-[20rpx] mb-[16rpx]">
              <view class="w-[72rpx] h-[72rpx] rounded-[18rpx] bg-primary/20 border border-primary/30 flex items-center justify-center shadow-[0_0_20rpx_rgba(46,213,115,0.3)]">
                <text class="i-fluent:vehicle-motorcycle-28-filled text-[36rpx] text-white" />
              </view>
              <view>
                <text class="text-[34rpx] font-800 text-white tracking-[2px]">襄阳摩友</text>
                <text class="text-[18rpx] text-primary/80 block mt-[2rpx] tracking-wider">XIANGYANG RIDER</text>
              </view>
            </view>
            <view class="flex items-center gap-[12rpx]">
              <view class="h-[4rpx] w-[60rpx] bg-gradient-to-r from-primary to-transparent rounded-full" />
              <text class="text-[22rpx] text-white/60 tracking-wide">追风之路 · 自由骑行</text>
            </view>
          </view>
        </view>
      </view>
      ...
      <view class="px-[24rpx] mt-[24rpx]">
        <view class="bg-card rounded-[24rpx] p-[28rpx] border border-white/10 shadow-lg">
          <view class="flex items-center justify-between mb-[24rpx]">
            <text class="text-[26rpx] font-600 text-white flex items-center gap-[8rpx]">
          ...
          <view class="grid grid-cols-3 gap-[12rpx]">
            <view class="flex flex-col items-center p-[16rpx] rounded-[16rpx]" :style="{ background: 'rgba(46, 213, 115, 0.08)' }">
              <text class="text-[38rpx] font-700 text-primary">{{ stats.totalRides }}</text>
              <text class="text-[22rpx] text-white mt-[8rpx]">骑行次数</text>
            </view>
            <view class="flex flex-col items-center p-[16rpx] rounded-[16rpx]" :style="{ background: 'rgba(46, 213, 115, 0.08)' }">
              <text class="text-[38rpx] font-700 text-primary">{{ stats.totalDistance }}</text>
              <text class="text-[22rpx] text-white mt-[8rpx]">总里程</text>
            </view>
            <view class="flex flex-col items-center p-[16rpx] rounded-[16rpx]" :style="{ background: 'rgba(46, 213, 115, 0.08)' }">
              <text class="text-[38rpx] font-700 text-primary">{{ Math.round(stats.totalDuration / 60 * 10) / 10 }}</text>
              <text class="text-[22rpx] text-white mt-[8rpx]">总时长</text>
            </view>
          </view>

          <view class="mt-[20rpx] pt-[20rpx] border-t border-white/10 grid grid-cols-2 gap-[16rpx]">
            <view class="flex items-center gap-[8rpx]">
              <text class="i-carbon:delta text-[20rpx] text-primary" />
              <text class="text-[20rpx] text-gray">均距</text>
              <text class="text-[22rpx] text-white font-600">{{ stats.avgDistance || 0 }}km</text>
            </view>
            <view class="flex items-center gap-[8rpx]">
              <text class="i-carbon:speedometer text-[20rpx] text-primary" />
              <text class="text-[20rpx] text-gray">均速</text>
              <text class="text-[22rpx] text-white font-600">{{ stats.avgSpeed || 0 }}km/h</text>
            </view>
          </view>
        </view>
      </view>
      ...
      <view class="px-[24rpx] mt-[24rpx]">
        <view class="flex items-center gap-[8rpx] mb-[16rpx]">
          ...
          <text class="text-[26rpx] font-600 text-white">功能中心</text>
        </view>

        <view class="bg-card rounded-[24rpx] overflow-hidden border border-white/10 shadow-lg">
          <view
          ...
          >
            <view class="flex items-center gap-[16rpx]">
              <view class="w-[56rpx] h-[56rpx] rounded-[14rpx] flex items-center justify-center" :style="{ background: 'rgba(46, 213, 115, 0.1)' }">
      ...
      <view class="px-[24rpx] mt-[24rpx]">
        <view class="flex items-center gap-[8rpx] mb-[16rpx]">
          ...
          <text class="text-[26rpx] font-600 text-white">设置</text>
        </view>
        ...
        <view class="bg-card rounded-[24rpx] overflow-hidden border border-white/10 shadow-lg">
          <view class="flex items-center justify-between p-[28rpx]">
            <view class="flex items-center gap-[16rpx]">
              ...
              <text class="text-[24rpx] text-white">深色模式</text>
            </view>
          ...
          <view
            class="flex items-center justify-between p-[28rpx] border-t border-white/10"
            @click="handleClearData"
          >
            <view class="flex items-center gap-[16rpx]">
              <view class="w-[56rpx] h-[56rpx] rounded-[14rpx] bg-red-500/15 flex items-center justify-center">
                <text class="i-carbon:renew text-[28rpx] text-red-500" />
              </view>
              <text class="text-[24rpx] text-white">清除本地数据</text>
            </view>
            <text class="i-carbon:chevron-right text-[24rpx] text-gray" />
          </view>
        </view>
      ...
      <view class="px-[24rpx] mt-[24rpx] pb-[40rpx]">
        <view class="bg-card rounded-[24rpx] p-[24rpx] border border-white/10 text-center">
          <text class="text-[20rpx] text-gray/60 block mb-[8rpx]">非盈利项目 · 本地存储 · 无数据上传</text>
          <text class="text-[18rpx] text-gray/40">襄阳摩友助手 v2.0</text>
        </view>
      </view>
    </view>
  </view>
