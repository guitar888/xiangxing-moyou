...
export default defineConfig({
  ...
  safelist: [
    'i-carbon:map', 'i-carbon:cloud', 'i-carbon:group', 'i-carbon:ruler', 'i-carbon:growth',
    'i-carbon:calendar', 'i-carbon:location', 'i-carbon:share', 'i-carbon:trash-can', 'i-carbon:time',
    'i-carbon:dashboard', 'i-carbon:star', 'i-carbon:star-filled', 'i-carbon:store', 'i-carbon:bicycle',
    ...
    'i-carbon:checkmark', 'i-carbon:search', 'i-carbon:security', 'i-carbon:notebook', 'i-carbon:apps',
    'i-carbon:compass', 'i-carbon:chart-line', 'i-carbon:pin', 'i-carbon:earth', 'i-carbon:mountain',
  ],
