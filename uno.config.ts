...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'shadow-card': 'shadow-[0_4rpx_16rpx rgba(0,0,0,0.2)]',
    'shadow-glow': 'shadow-[0_0_20rpx rgba(46,213,115,0.3)]',
    'shadow-inset': 'shadow-[inset_0_1rpx_0 rgba(255,255,255,0.05)]',
    'rounded-sm': 'rounded-[8rpx]',
    'rounded-md': 'rounded-[12rpx]',
    'rounded-lg': 'rounded-[16rpx]',
  },
  safelist: ['i-carbon:map', 'i-carbon:cloud'],
})
